...
})({"cd198":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "f7aaca66cec727a7";
"use strict";
...
const resolveFetch = (customFetch)=>{
    ...
    if (customFetch) _fetch = customFetch;
            ...
            return yield (yield require("af9490f3edef29ff")).fetch(...args);
        });
    else _fetch = fetch;
    return (...args)=>_fetch(...args);
};

},{"af9490f3edef29ff":"dQm8Z","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dQm8Z":[function(require,module,exports) {
...
if (typeof globalThis === "object") _globalThis = globalThis;
    ...
    _globalThis = require("e5f48a1ecb95faba");
} catch (error) {} finally{
    if (!_globalThis && typeof window !== "undefined") _globalThis = window;
    if (!_globalThis) throw new Error("Could not determine global this");
}
var NativeWebSocket = _globalThis.WebSocket || _globalThis.MozWebSocket;
var websocket_version = require("514af9c892c379f3");
/**
...
},{"e5f48a1ecb95faba":"i0Mdn","514af9c892c379f3":"itgdA"}],"i0Mdn":[function(require,module,exports) {
...
module.exports = require("a54a4185ccfb33ea").version;

},{"a54a4185ccfb33ea":"fCYcm"}],"fCYcm":[function(require,module,exports) {
...
const resolveFetch = (customFetch)=>{
    ...
    if (customFetch) _fetch = customFetch;
            ...
            return yield (yield require("77b51dbfb691b557")).fetch(...args);
        });
    else _fetch = fetch;
    return (...args)=>_fetch(...args);
};
const resolveResponse = ()=>__awaiter(void 0, void 0, void 0, function*() {
        if (typeof Response === "undefined") return (yield require("77b51dbfb691b557")).Response;
        return Response;
    });

},{"77b51dbfb691b557":"dQm8Z","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"caYeW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _constants = require("../lib/constants");
var _errors = require("../lib/errors");
...
const resolveFetch = (customFetch)=>{
    ...
    if (customFetch) _fetch = customFetch;
            ...
            return yield (yield require("472be0600a886f34")).fetch(...args);
        });
    else _fetch = fetch;
    return (...args)=>_fetch(...args);
};
...
},{"472be0600a886f34":"dQm8Z","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bDFnv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
/** Current session will be checked for refresh at this interval. */ const AUTO_REFRESH_TICK_DURATION = 10000;
/**
...
class GoTrueClient {
     ...
     */ _getSessionFromUrl() {
        return __awaiter(this, void 0, void 0, function*() {
            try {
                ...
                if (!this._isImplicitGrantFlow()) throw new (0, _errors.AuthImplicitGrantRedirectError)("Not a valid implicit grant flow url.");
     ...
     */ _handleVisibilityChange() {
        return __awaiter(this, void 0, void 0, function*() {
            ...
            try {
                window === null || window === void 0 || window.addEventListener("visibilitychange", ()=>__awaiter(this, void 0, void 0, function*() {
     ...
     */ _onVisibilityChanged(isInitial) {
        return __awaiter(this, void 0, void 0, function*() {
            if (document.visibilityState === "visible") {
                ...
                if (this.autoRefreshToken) this.stopAutoRefresh();
            }
        });
    }
    /**
...
const localStorageAdapter = {
    getItem: (key)=>{
        if (!(0, _helpers.isBrowser)()) return null;
        return globalThis.localStorage.getItem(key);
    },
    setItem: (key, value)=>{
        if (!(0, _helpers.isBrowser)()) return;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cd198","cmW8E"], "cmW8E", "parcelRequire40bb")

//# sourceMappingURL=index.cec727a7.js.map
